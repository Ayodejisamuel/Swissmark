        ...
        <div id='footer-container'>
            <div className='footer-wrapper'>
                ...
                <div className='formdiv'>
                    ...
                    <div className='emaildiv'>< img src={message} alt={message} width={17} height={17} className='emailimg' /> <input type='email' placeholder='Email Your Email Address'></input>< img src={arrow} alt={arrow} width={17} height={17} className='emailimgg' /></div><br />
                    <div className='imgcontactdivv'><img src={location} alt={location} className='imgcontactimgg' width={17} height={17} ></img> <span>6b Bendel Close, Off Bishop Aboyade Cole, Victoria Island, Lagos, Nigeria</span></div>
                    <div className='imgcontactdivv'><img src={call} alt={call} className='imgcontactimg' width={17} height={17} ></img> <span>+234-1 342 8350</span></div>
                    ...
                    <div className='imgcontactdivv'><img src={message} alt={message} className='imgcontactimg' width={17} height={17}  ></img> <span>info@swissmarkk.com</span></div>
